...
class Class34VC: UIViewController {

    //Variables
    var playerName = ["Anna", "Nayeli", "Angel", "Daryl", "Karla", "Mariano", "Haley H", "Padilla", "Katelyn", "Josephine", "Lissette", "Alyssa", "Aracely", "Brenda", "Valerie", "Leonel", "Christian", "Angie", "Starr", "Tony", "Bri", "Kayla", "America", "Damien", "Itch-Kitchy", "Santiago", "Prissy", "Emely", "Jackie", "Jacob", "Jacson", "Soliz"]
